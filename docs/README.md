...
RSpec helpers for testing [Esse](../../esse/docs/README.md)-backed code without hitting a live Elasticsearch/OpenSearch cluster. Stub search and transport calls, assert on request payloads, and scaffold disposable `Esse::Index` classes inside your specs.
